...
export function PotreeSidebar({
  ...
  return (
    <div className={`absolute top-0 left-0 z-20 w-[320px] h-screen bg-slate-950/95 border-r border-slate-800 text-slate-300 flex flex-col font-sans select-none transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
      }`}>
      {/* Header chính */}
      <div className="p-4 border-b border-slate-900 bg-slate-900/60 flex items-center justify-between">
        ...
        <button
          ...
          className={`px-2.5 py-1 text-[10px] font-bold uppercase rounded border transition-all ${isOptimizerOpen
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-4 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-lg flex flex-col items-center justify-center gap-1 border transition-all ${currentMode === 'distance'
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-lg flex flex-col items-center justify-center gap-1 border transition-all ${currentMode === 'height'
                        ? 'bg-sky-500/20 border-sky-500 text-sky-400'
                        : 'border-slate-800 bg-slate-900/40 text-slate-400 hover:bg-slate-900 hover:text-slate-200'
                      }`}
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-lg flex flex-col items-center justify-center gap-1 border transition-all ${currentMode === 'area'
                        ? 'bg-sky-500/20 border-sky-500 text-sky-400'
                        : 'border-slate-800 bg-slate-900/40 text-slate-400 hover:bg-slate-900 hover:text-slate-200'
                      }`}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex bg-slate-900 rounded-lg p-0.5 border border-slate-800 text-[10px] font-bold">
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-md transition-all ${!isOrthographic
